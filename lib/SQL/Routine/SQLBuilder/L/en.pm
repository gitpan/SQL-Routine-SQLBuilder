...
The SQL::Routine::SQLBuilder::L::en Perl 5 module contains localization
data for SQL::Routine::SQLBuilder.  It is designed to be interpreted by
Locale::KeyedText.  Besides localizing generic error messages that
SQL::Routine::SQLBuilder produces itself, this file also provides a
...
on CPAN, or on L<SQL::Routine::SQLBuilder>, which is in the current
