...
is( $SQL::Routine::SQLBuilder::VERSION, qv('0.21.2'), 'SQL::Routine::SQLBuilder is the correct version' );

use_ok( 'SQL::Routine::SQLBuilder::L::en' );
is( $SQL::Routine::SQLBuilder::L::en::VERSION, qv('0.2.2'), 'SQL::Routine::SQLBuilder::L::en is the correct version' );
